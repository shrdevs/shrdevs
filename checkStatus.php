    ...
    <div class="row">
        <div class="col-md-3">
            <div class="sidebar">
                <div class="sidebar-menu">
                    ...
                    <li class="item">
                        <a href="checkStatus.php" class="menu-btn">
                    ...
                    <li class="item" id="profile">
                        ...
                        <div class="sub-menu">
                            <a href="branchReplied.php"><i class="fa fa-image"></i><span>Branch Replied</span></a>
                            <a href="yetNotReplied.php"><i class="fa fa-address-card"></i><span>Yet Not Replied</span></a>
        ...
        <div class="col-md-9 content">
            <div class="content-body">
                ...
                <div class="content-body">
                    <h2 style="color:#55B1F0;margin-left:200px;">Status Information</h2>
                    <hr>
