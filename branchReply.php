...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-7 content">
            <h2 style="color:#55B1F0;margin-left:200px;">Reply Notice</h2>
            <hr>
            <br>
            <div class="content-body">
                <form action="branchReplyApi.php" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="fcf-form-group">
                        <label for="Email" class="fcf-label">Letter No</label>
                        <div class="fcf-input-group">
                            <input type="text" id="notice_refno" name="notice_refno" class="fcf-form-control" value="<?php echo $_REQUEST['refno'] ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="fcf-form-group">
                        ...
                        <div class="fcf-input-group">
                            <input type="text" id="subject" name="fsib_subject" class="fcf-form-control" value="<?php echo $_REQUEST['sub'] ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="file" class="form-control-file" id="attachFile" name = "files[]" multiple required>
                        </div>
                    </div>

                    <div class="fcf-form-group">
                        <button type="submit" name = "reply_notice" id="fcf-button" class="fcf-btn fcf-btn-primary fcf-btn-lg fcf-btn-block">Forward to Maker</button>
                    </div>
                </form>
            </div>
        </div>
